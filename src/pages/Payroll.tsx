              ...
              <TableBody>
                {payrollData.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-center">{item.workingDays}</TableCell>
                    <TableCell className="text-right">₹{item.salary.basic.toLocaleString()}</TableCell>
                    <TableCell className="text-right">₹{item.salary.hra.toLocaleString()}</TableCell>
                    <TableCell className="text-right">₹{item.salary.specialAllowance.toLocaleString()}</TableCell>
                    <TableCell className="text-right">₹{item.salary.pfContribution.toLocaleString()}</TableCell>
                    <TableCell className="text-right">₹{item.salary.tax.toLocaleString()}</TableCell>
                    <TableCell className="text-right font-semibold">₹{item.salary.gross.toLocaleString()}</TableCell>
                    <TableCell className="text-right font-semibold">₹{item.salary.net.toLocaleString()}</TableCell>
                    <TableCell className="text-center">
                      <Button variant="outline" size="sm" onClick={() => handleDownloadPayslip(item.id)}>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-6 gap-4 py-2">
              <div className="col-span-2">March 2025</div>
              <div className="col-span-1 text-right">₹85,000</div>
              <div className="col-span-1 text-right">₹70,500</div>
            ...
            <div className="grid grid-cols-6 gap-4 py-2">
              <div className="col-span-2">February 2025</div>
              <div className="col-span-1 text-right">₹85,000</div>
              <div className="col-span-1 text-right">₹70,500</div>
              <div className="col-span-1 text-center">
                <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
            ...
            <div className="grid grid-cols-6 gap-4 py-2">
              <div className="col-span-2">January 2025</div>
              <div className="col-span-1 text-right">₹85,000</div>
              <div className="col-span-1 text-right">₹70,500</div>
              <div className="col-span-1 text-center">
                <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
